...
void CubeMvpTexturedDraw::start() {
    program = GLProgram::createByShaderName("cubemvptexture");
...
void CubeMvpTexturedDraw::update(float deltaTime) {
    //6. Draw Call
...
void CubeMvpTexturedDraw::destroy() {
